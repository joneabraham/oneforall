              ...
              child: InkWell(
                onTap: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => BidingoptionWidget(),
                    ),
                  );
                },
                child: FaIcon(
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 40, 0, 44),
                    child: Wrap(
                      spacing: 8,
                      runSpacing: 8,
                            ...
                            child: InkWell(
                              onTap: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => Smartphone1Widget(),
                                  ),
                                );
                              },
                              child: Column(
