...
part of 'headphone_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<HeadphoneRecord> _$headphoneRecordSerializer =
    new _$HeadphoneRecordSerializer();

class _$HeadphoneRecordSerializer
    implements StructuredSerializer<HeadphoneRecord> {
  @override
  final Iterable<Type> types = const [HeadphoneRecord, _$HeadphoneRecord];
  @override
  final String wireName = 'HeadphoneRecord';

  @override
  Iterable<Object> serialize(Serializers serializers, HeadphoneRecord object,
  ...
  @override
  HeadphoneRecord deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new HeadphoneRecordBuilder();
...
class _$HeadphoneRecord extends HeadphoneRecord {
  @override
  ...
  factory _$HeadphoneRecord([void Function(HeadphoneRecordBuilder) updates]) =>
      (new HeadphoneRecordBuilder()..update(updates)).build();
  ...
  @override
  HeadphoneRecord rebuild(void Function(HeadphoneRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  HeadphoneRecordBuilder toBuilder() =>
      new HeadphoneRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HeadphoneRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('HeadphoneRecord')
...
class HeadphoneRecordBuilder
    implements Builder<HeadphoneRecord, HeadphoneRecordBuilder> {
  _$HeadphoneRecord _$v;
  ...
  HeadphoneRecordBuilder() {
    HeadphoneRecord._initializeBuilder(this);
  }

  HeadphoneRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HeadphoneRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$HeadphoneRecord;
  }

  @override
  void update(void Function(HeadphoneRecordBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$HeadphoneRecord build() {
    final _$result = _$v ??
        new _$HeadphoneRecord._(
