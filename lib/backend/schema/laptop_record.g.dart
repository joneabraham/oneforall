...
part of 'laptop_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<LaptopRecord> _$laptopRecordSerializer =
    new _$LaptopRecordSerializer();

class _$LaptopRecordSerializer implements StructuredSerializer<LaptopRecord> {
  @override
  final Iterable<Type> types = const [LaptopRecord, _$LaptopRecord];
  @override
  final String wireName = 'LaptopRecord';

  @override
  Iterable<Object> serialize(Serializers serializers, LaptopRecord object,
  ...
  @override
  LaptopRecord deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new LaptopRecordBuilder();
...
class _$LaptopRecord extends LaptopRecord {
  @override
  ...
  factory _$LaptopRecord([void Function(LaptopRecordBuilder) updates]) =>
      (new LaptopRecordBuilder()..update(updates)).build();
  ...
  @override
  LaptopRecord rebuild(void Function(LaptopRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LaptopRecordBuilder toBuilder() => new LaptopRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LaptopRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('LaptopRecord')
...
class LaptopRecordBuilder
    implements Builder<LaptopRecord, LaptopRecordBuilder> {
  _$LaptopRecord _$v;
  ...
  LaptopRecordBuilder() {
    LaptopRecord._initializeBuilder(this);
  }

  LaptopRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(LaptopRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$LaptopRecord;
  }

  @override
  void update(void Function(LaptopRecordBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$LaptopRecord build() {
    final _$result = _$v ??
        new _$LaptopRecord._(
