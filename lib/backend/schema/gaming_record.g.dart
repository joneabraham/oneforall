...
part of 'gaming_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GamingRecord> _$gamingRecordSerializer =
    new _$GamingRecordSerializer();

class _$GamingRecordSerializer implements StructuredSerializer<GamingRecord> {
  @override
  final Iterable<Type> types = const [GamingRecord, _$GamingRecord];
  @override
  final String wireName = 'GamingRecord';

  @override
  Iterable<Object> serialize(Serializers serializers, GamingRecord object,
  ...
  @override
  GamingRecord deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GamingRecordBuilder();
...
class _$GamingRecord extends GamingRecord {
  @override
  ...
  factory _$GamingRecord([void Function(GamingRecordBuilder) updates]) =>
      (new GamingRecordBuilder()..update(updates)).build();
  ...
  @override
  GamingRecord rebuild(void Function(GamingRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GamingRecordBuilder toBuilder() => new GamingRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GamingRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GamingRecord')
...
class GamingRecordBuilder
    implements Builder<GamingRecord, GamingRecordBuilder> {
  _$GamingRecord _$v;
  ...
  GamingRecordBuilder() {
    GamingRecord._initializeBuilder(this);
  }

  GamingRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(GamingRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GamingRecord;
  }

  @override
  void update(void Function(GamingRecordBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GamingRecord build() {
    final _$result = _$v ??
        new _$GamingRecord._(
